// WARNING!!!! THIS SCRIPT IS DESTRUCTIVE AND CAN RAPIDLY DEGRADE SYSTEMS IF USED NOT IN A CONTAINED ENV.
// ALWAYS HAVE CONSENT AND OR OWN THE MACHINE THIS MALWARE IS TESTED ON.
// THIS SCRIPT IS VERY HARD TO STOP WITHOUT KNOWING WHAT TO DO. 
// THIS SCRIPT CREATES MANY COPIES OF ITSELF.
// Fuck you, kbhaha0_0 feel free to skid this.
import sys
import random
import string
import psutil
